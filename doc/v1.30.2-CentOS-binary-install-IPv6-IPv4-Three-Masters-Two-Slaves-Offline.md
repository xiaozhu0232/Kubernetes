...
| Master01 | 192.168.50.31 | master节点 | kube-apiserver、kube-controller-manager、kube-scheduler、etcd、<br />kubelet、kube-proxy、nfs-client、haproxy、keepalived、nginx |
| Master02 | 192.168.50.32 | master节点 | kube-apiserver、kube-controller-manager、kube-scheduler、etcd、<br />kubelet、kube-proxy、nfs-client、haproxy、keepalived、nginx |
| Master03 | 192.168.50.33 | master节点 | kube-apiserver、kube-controller-manager、kube-scheduler、etcd、<br />kubelet、kube-proxy、nfs-client、haproxy、keepalived、nginx |
| Node01   | 192.168.50.34 | node节点   | kubelet、kube-proxy、nfs-client、nginx                        |
| Node02   | 192.168.50.35 | node节点   | kubelet、kube-proxy、nfs-client、nginx                        |
| Node03   | 192.168.50.36 | node节点   | kubelet、kube-proxy、nfs-client、nginx                        |
|          | 192.168.50.60 | VIP        |                                                              |
...
ssh root@192.168.50.31 "nmcli con delete uuid 8e8afb37-9cb4-362e-ba72-82568cb54312;nmcli con add type ethernet ifname ens18 con-name ens18;nmcli con up ens18"
ssh root@192.168.50.32 "nmcli con delete uuid 8e8afb37-9cb4-362e-ba72-82568cb54312;nmcli con add type ethernet ifname ens18 con-name ens18;nmcli con up ens18"
ssh root@192.168.50.33 "nmcli con delete uuid 8e8afb37-9cb4-362e-ba72-82568cb54312;nmcli con add type ethernet ifname ens18 con-name ens18;nmcli con up ens18"
ssh root@192.168.50.34 "nmcli con delete uuid 8e8afb37-9cb4-362e-ba72-82568cb54312;nmcli con add type ethernet ifname ens18 con-name ens18;nmcli con up ens18"
ssh root@192.168.50.35 "nmcli con delete uuid 8e8afb37-9cb4-362e-ba72-82568cb54312;nmcli con add type ethernet ifname ens18 con-name ens18;nmcli con up ens18"
...
# 修改静态的IPv4地址
ssh root@192.168.1.158 "nmcli con mod ens18 ipv4.addresses 192.168.50.31/24; nmcli con mod ens18 ipv4.gateway  192.168.1.1; nmcli con mod ens18 ipv4.method manual; nmcli con mod ens18 ipv4.dns "8.8.8.8"; nmcli con up ens18"
ssh root@192.168.1.151 "nmcli con mod ens18 ipv4.addresses 192.168.50.32/24; nmcli con mod ens18 ipv4.gateway  192.168.1.1; nmcli con mod ens18 ipv4.method manual; nmcli con mod ens18 ipv4.dns "8.8.8.8"; nmcli con up ens18"
ssh root@192.168.1.152 "nmcli con mod ens18 ipv4.addresses 192.168.50.33/24; nmcli con mod ens18 ipv4.gateway  192.168.1.1; nmcli con mod ens18 ipv4.method manual; nmcli con mod ens18 ipv4.dns "8.8.8.8"; nmcli con up ens18"
ssh root@192.168.1.157 "nmcli con mod ens18 ipv4.addresses 192.168.50.34/24; nmcli con mod ens18 ipv4.gateway  192.168.1.1; nmcli con mod ens18 ipv4.method manual; nmcli con mod ens18 ipv4.dns "8.8.8.8"; nmcli con up ens18"
ssh root@192.168.1.155 "nmcli con mod ens18 ipv4.addresses 192.168.50.35/24; nmcli con mod ens18 ipv4.gateway  192.168.1.1; nmcli con mod ens18 ipv4.method manual; nmcli con mod ens18 ipv4.dns "8.8.8.8"; nmcli con up ens18"
...
# 
# "nmcli con mod ens18 ipv4.addresses 192.168.50.31/24"
...
# 没有固定IPv6选择不配置即可
ssh root@192.168.50.31 "nmcli con mod ens18 ipv6.addresses fc00:43f4:1eea:1::10; nmcli con mod ens18 ipv6.gateway fc00:43f4:1eea:1::1; nmcli con mod ens18 ipv6.method manual; nmcli con mod ens18 ipv6.dns "2400:3200::1"; nmcli con up ens18"
ssh root@192.168.50.32 "nmcli con mod ens18 ipv6.addresses fc00:43f4:1eea:1::20; nmcli con mod ens18 ipv6.gateway fc00:43f4:1eea:1::1; nmcli con mod ens18 ipv6.method manual; nmcli con mod ens18 ipv6.dns "2400:3200::1"; nmcli con up ens18"
ssh root@192.168.50.33 "nmcli con mod ens18 ipv6.addresses fc00:43f4:1eea:1::30; nmcli con mod ens18 ipv6.gateway fc00:43f4:1eea:1::1; nmcli con mod ens18 ipv6.method manual; nmcli con mod ens18 ipv6.dns "2400:3200::1"; nmcli con up ens18"
ssh root@192.168.50.34 "nmcli con mod ens18 ipv6.addresses fc00:43f4:1eea:1::40; nmcli con mod ens18 ipv6.gateway fc00:43f4:1eea:1::1; nmcli con mod ens18 ipv6.method manual; nmcli con mod ens18 ipv6.dns "2400:3200::1"; nmcli con up ens18"
ssh root@192.168.50.35 "nmcli con mod ens18 ipv6.addresses fc00:43f4:1eea:1::50; nmcli con mod ens18 ipv6.gateway fc00:43f4:1eea:1::1; nmcli con mod ens18 ipv6.method manual; nmcli con mod ens18 ipv6.dns "2400:3200::1"; nmcli con up ens18"
...
[ethernet]
[ipv4]
address1=192.168.50.31/24,192.168.1.1
dns=8.8.8.8;
method=manual
[ipv6]
...
# 3. `[ipv4]`:
#    - `address1`: 以CIDR表示法指定IPv4地址和子网掩码（`192.168.50.31/24`）。还包括网关IP（`192.168.1.1`）。
...
# 
# 参数: k8s-master1
# 解释: 这是要设置的主机名，将系统的主机名设置为"k8s-master1"。
```
...
# 拷贝包到内网机器上
scp -r /data/centos7/ root@192.168.50.31:
scp -r /data/centos7/ root@192.168.50.32:
scp -r /data/centos7/ root@192.168.50.33:
scp -r /data/centos7/ root@192.168.50.34:
scp -r /data/centos7/ root@192.168.50.35:
...
# 拷贝包到内网机器上
scp -r centos8/ root@192.168.50.31:
scp -r centos8/ root@192.168.50.32:
scp -r centos8/ root@192.168.50.33:
scp -r centos8/ root@192.168.50.34:
scp -r centos8/ root@192.168.50.35:
...
# 拷贝包到内网机器上
scp -r centos9/ root@192.168.50.31:
scp -r centos9/ root@192.168.50.32:
scp -r centos9/ root@192.168.50.33:
scp -r centos9/ root@192.168.50.34:
scp -r centos9/ root@192.168.50.35:
...
# 拷贝包到内网机器上
scp -r ubuntu/ root@192.168.50.31:
scp -r ubuntu/ root@192.168.50.32:
scp -r ubuntu/ root@192.168.50.33:
scp -r ubuntu/ root@192.168.50.34:
scp -r ubuntu/ root@192.168.50.35:
...
export IP="192.168.50.31 192.168.50.32 192.168.50.33 192.168.50.34 192.168.50.35"
...
# 
# 3. `export IP="192.168.50.31 192.168.50.32 192.168.50.33 192.168.50.34 192.168.50.35"`：设置一个包含多个远程主机IP地址的环境变量IP，用空格分隔开，表示要将SSH公钥复制到这些远程主机上。
# 
...
192.168.50.31 k8s-master1
192.168.50.32 k8s-master2
192.168.50.33 k8s-master3
192.168.50.34 k8s-node1
192.168.50.35 k8s-node2
192.168.50.36 k8s-node3
192.168.50.60 lb-vip
EOF
```
...
cfssl gencert \
   ...
   -hostname=127.0.0.1,k8s-master1,k8s-master2,k8s-master3,192.168.50.31,192.168.50.32,192.168.50.33,::1 \
   -profile=kubernetes \
...
-config=ca-config.json   \
-hostname=10.96.0.1,192.168.50.60,127.0.0.1,kubernetes,kubernetes.default,kubernetes.default.svc,kubernetes.default.svc.cluster,kubernetes.default.svc.cluster.local,x.oiox.cn,z.oiox.cn,192.168.50.31,192.168.50.32,192.168.50.33,192.168.50.34,192.168.50.35,192.168.50.60,192.168.0.47,192.168.0.48,192.168.0.49,192.168.1.50,::1   \
...
# - `-hostname=10.96.0.1,192.168.50.60,127.0.0.1,fc00:43f4:1eea:1::10`：指定证书的主机名或IP地址列表。
...
若使用 haproxy、keepalived 那么为 `--server=https://192.168.50.60:9443`
...
listen-client-urls: 'https://192.168.50.31:2379,http://127.0.0.1:2379'
max-snapshots: 3
max-wals: 5
cors:
initial-advertise-peer-urls: 'https://192.168.50.31:2380'
advertise-client-urls: 'https://192.168.50.31:2379'
discovery:
discovery-fallback: 'proxy'
discovery-proxy:
discovery-srv:
initial-cluster: 'k8s-master1=https://192.168.50.31:2380,k8s-master2=https://192.168.50.32:2380,k8s-master3=https://192.168.50.33:2380'
...
election-timeout: 1000
quota-backend-bytes: 0
listen-peer-urls: 'https://192.168.50.32:2380'
listen-client-urls: 'https://192.168.50.32:2379,http://127.0.0.1:2379'
max-snapshots: 3
max-wals: 5
cors:
initial-advertise-peer-urls: 'https://192.168.50.32:2380'
advertise-client-urls: 'https://192.168.50.32:2379'
discovery:
discovery-fallback: 'proxy'
discovery-proxy:
discovery-srv:
...
election-timeout: 1000
quota-backend-bytes: 0
listen-peer-urls: 'https://192.168.50.33:2380'
listen-client-urls: 'https://192.168.50.33:2379,http://127.0.0.1:2379'
max-snapshots: 3
max-wals: 5
cors:
initial-advertise-peer-urls: 'https://192.168.50.33:2380'
advertise-client-urls: 'https://192.168.50.33:2379'
discovery:
discovery-fallback: 'proxy'
discovery-proxy:
discovery-srv:
...
etcdctl --endpoints="192.168.50.33:2379,192.168.50.32:2379,192.168.50.31:2379" --cacert=/etc/kubernetes/pki/etcd/etcd-ca.pem --cert=/etc/kubernetes/pki/etcd/etcd.pem --key=/etc/kubernetes/pki/etcd/etcd-key.pem  endpoint status --write-out=table
+-------------------+------------------+---------+---------+-----------+------------+-----------+------------+--------------------+--------+
|     ENDPOINT      |        ID        | VERSION | DB SIZE | IS LEADER | IS LEARNER | RAFT TERM | RAFT INDEX | RAFT APPLIED INDEX | ERRORS |
+-------------------+------------------+---------+---------+-----------+------------+-----------+------------+--------------------+--------+
| 192.168.50.33:2379 | 29ba1a59fc9631ce |  3.5.13 |   20 kB |     false |      false |         3 |         13 |                 13 |        |
| 192.168.50.32:2379 | 987ed990c5d78aa4 |  3.5.13 |   33 kB |     false |      false |         3 |         13 |                 13 |        |
| 192.168.50.31:2379 | 3f3d8e1e5a05c016 |  3.5.13 |   20 kB |      true |      false |         3 |         13 |                 13 |        |
+-------------------+------------------+---------+---------+-----------+------------+-----------+------------+--------------------+--------+

# 这个命令是使用etcdctl工具，用于查看指定etcd集群的健康状态。下面是每个参数的详细解释：
# 
# - `--endpoints`：指定要连接的etcd集群节点的地址和端口。在这个例子中，指定了3个节点的地址和端口，分别是`192.168.50.33:2379,192.168.50.32:2379,192.168.50.31:2379`。
...
stream {
    upstream backend {
        ...
        server 192.168.50.31:6443        max_fails=3 fail_timeout=30s;
        server 192.168.50.32:6443        max_fails=3 fail_timeout=30s;
        server 192.168.50.33:6443        max_fails=3 fail_timeout=30s;
    }
    server {
...
backend k8s-master
 ...
 server  k8s-master1  192.168.50.31:6443 check
 server  k8s-master2  192.168.50.32:6443 check
 server  k8s-master3  192.168.50.33:6443 check
EOF
```
参数
...
5. backend k8s-master:
   ...
   - server k8s-master1 192.168.50.31:6443 check: 增加一个名为k8s-master01的服务器，IP地址为192.168.1.41，端口号为6443，并对其进行健康检查。
   - server k8s-master2 192.168.50.32:6443 check: 增加一个名为k8s-master02的服务器，IP地址为192.168.1.42，端口号为6443，并对其进行健康检查。
   - server k8s-master3 192.168.50.33:6443 check: 增加一个名为k8s-master03的服务器，IP地址为192.168.1.43，端口号为6443，并对其进行健康检查。
...
```shell
# 能ping同
[root@k8s-node2 ~]# ping 192.168.50.60

# 能telnet访问
[root@k8s-node2 ~]# telnet 192.168.50.60 9443
...
ExecStart=/usr/local/bin/kube-apiserver \\
      ...
      --secure-port=6443  \\
      --advertise-address=192.168.50.31 \\
      --service-cluster-ip-range=10.96.0.0/12,fd00:1111::/112  \\
      --service-node-port-range=30000-32767  \\
      --etcd-servers=https://192.168.50.31:2379,https://192.168.50.32:2379,https://192.168.50.33:2379 \\
...
ExecStart=/usr/local/bin/kube-apiserver \\
      ...
      --bind-address=0.0.0.0  \\
      --secure-port=6443  \\
      --advertise-address=192.168.50.32 \\
      --service-cluster-ip-range=10.96.0.0/12,fd00:1111::/112  \\
      --service-node-port-range=30000-32767  \\
      --etcd-servers=https://192.168.50.31:2379,https://192.168.50.32:2379,https://192.168.50.33:2379 \\
      --etcd-cafile=/etc/etcd/ssl/etcd-ca.pem  \\
...
ExecStart=/usr/local/bin/kube-apiserver \\
      ...
      --bind-address=0.0.0.0  \\
      --secure-port=6443  \\
      --advertise-address=192.168.50.33 \\
      --service-cluster-ip-range=10.96.0.0/12,fd00:1111::/112  \\
      --service-node-port-range=30000-32767  \\
      --etcd-servers=https://192.168.50.31:2379,https://192.168.50.32:2379,https://192.168.50.33:2379 \\
      --etcd-cafile=/etc/etcd/ssl/etcd-ca.pem  \\
...
- `--advertise-address=192.168.50.31` 广告API Server的地址。
- `--service-cluster-ip-range=10.96.0.0/12,fd00:1111::/112` 指定服务CIDR范围。
- `--service-node-port-range=30000-32767` 指定NodePort的范围。
- `--etcd-servers=https://192.168.50.31:2379,https://192.168.50.32:2379,https://192.168.50.33:2379` 指定etcd服务器的地址。
...
for NODE in k8s-master2 k8s-master3 k8s-node1 k8s-node2 k8s-node3; do ssh $NODE mkdir -p /etc/kubernetes/pki; for FILE in pki/ca.pem pki/ca-key.pem pki/front-proxy-ca.pem bootstrap-kubelet.kubeconfig kube-proxy.kubeconfig; do scp /etc/kubernetes/$FILE $NODE:/etc/kubernetes/${FILE}; done; done
```
...
ExecStart=/usr/local/bin/kubelet \\
    ...
    --container-runtime-endpoint=unix:///run/cri-dockerd.sock  \\
    --node-labels=node.kubernetes.io/node=   \\
    --node-ip=192.168.50.31,2408:822a:736:82b1::da3
[Install]
WantedBy=multi-user.target
EOF
```
...
ExecStart=/usr/local/bin/kubelet \\
    ...
    --container-runtime-endpoint=unix:///run/containerd/containerd.sock  \\
    --node-labels=node.kubernetes.io/node=  \\
    --node-ip=192.168.50.31,2408:822a:245:8c01::fab
[Install]
WantedBy=multi-user.target
EOF
```
...
k8s-master1   Ready    <none>   16s   v1.30.2
k8s-master2   Ready    <none>   13s   v1.30.2
k8s-master3   Ready    <none>   12s   v1.30.2
k8s-node1     Ready    <none>   10s   v1.30.2
k8s-node2     Ready    <none>   9s    v1.30.2
k8s-node3     Ready    <none>   9s    v1.30.2
[root@k8s-master1 ~]#
```
...
```shell
# master-1执行
for NODE in k8s-master2 k8s-master3 k8s-node1 k8s-node2 k8s-node3; do scp /etc/kubernetes/kube-proxy.kubeconfig $NODE:/etc/kubernetes/kube-proxy.kubeconfig; done
```
...
```shell
[root@k8s-master1 yaml]# wget https://mirrors.chenby.cn/https://raw.githubusercontent.com/cilium/cilium/1.12.1/examples/kubernetes/addons/prometheus/monitoring-example.yaml

[root@k8s-master1 yaml]# sed -i "s#docker.io/#docker.chenby.cn/#g" monitoring-example.yaml
...
```shell
http://192.168.50.31:30707
http://192.168.50.31:31155
http://192.168.50.31:31219
```
...
k8s-master1   268m         6%     2318Mi          60%       
k8s-master2   147m         3%     1802Mi          47%       
k8s-master3   147m         3%     1820Mi          47%       
k8s-node1     62m          1%     1152Mi          30%       
k8s-node2     63m          1%     1114Mi          29%  
```
...
NAME                                       READY   STATUS    RESTARTS   AGE     IP               NODE           NOMINATED NODE   READINESS GATES
calico-kube-controllers-76754ff848-pw4xg   1/1     Running   0          38m     172.25.244.193   k8s-master1   <none>           <none>
calico-node-97m55                          1/1     Running   0          38m     192.168.50.34     k8s-node1     <none>           <none>
calico-node-hlz7j                          1/1     Running   0          38m     192.168.50.32     k8s-master2   <none>           <none>
calico-node-jtlck                          1/1     Running   0          38m     192.168.50.33     k8s-master3   <none>           <none>
calico-node-lxfkf                          1/1     Running   0          38m     192.168.50.35     k8s-node2     <none>           <none>
calico-node-t667x                          1/1     Running   0          38m     192.168.50.31     k8s-master1   <none>           <none>
calico-typha-59d75c5dd4-gbhfp              1/1     Running   0          38m     192.168.50.35     k8s-node2     <none>           <none>
coredns-coredns-c5c6d4d9b-bd829            1/1     Running   0          10m     172.25.92.65     k8s-master2   <none>           <none>
metrics-server-7c8b55c754-w7q8v            1/1     Running   0          3m56s   172.17.125.3     k8s-node1     <none>           <none>

# 进入busybox ping其他节点上的pod

kubectl exec -ti busybox -- sh
/ # ping 192.168.50.34
PING 192.168.50.34 (192.168.50.34): 56 data bytes
64 bytes from 192.168.50.34: seq=0 ttl=63 time=0.358 ms
64 bytes from 192.168.50.34: seq=1 ttl=63 time=0.668 ms
64 bytes from 192.168.50.34: seq=2 ttl=63 time=0.637 ms
64 bytes from 192.168.50.34: seq=3 ttl=63 time=0.624 ms
64 bytes from 192.168.50.34: seq=4 ttl=63 time=0.907 ms
...
# 删除nginx
[root@k8s-master1 ~]# kubectl delete deployments nginx-deployment 
```
...
```shell
[root@k8s-master1 ~]# kubectl get svc kubernetes-dashboard-kong-proxy -n kube-system
NAME                              TYPE       CLUSTER-IP     EXTERNAL-IP   PORT(S)         AGE
...
ingress-host-bar   nginx   hello.chenby.cn,demo.chenby.cn   192.168.50.32   80      7s
...
[root@localhost yaml]# curl -I http://192.168.50.31:30495
HTTP/1.1 200 OK
Server: nginx/1.21.6
...
kubectl taint nodes k8s-master1 key1=value1:NoExecute
kubectl taint nodes k8s-master2 key1=value1:NoExecute
kubectl taint nodes k8s-master3 key1=value1:NoExecute
...
kubectl taint nodes k8s-master1 key1=value1:NoSchedule
kubectl taint nodes k8s-master2 key1=value1:NoSchedule
kubectl taint nodes k8s-master3 key1=value1:NoSchedule
...
# 传输到各个节点
for NODE in k8s-master1 k8s-master2 k8s-master3 k8s-node1 k8s-node2 k8s-node3; do scp -r images/  $NODE:/root/ ; done
